...
show tables;
drop table  employee;
create table employee(emp_id int,emp_name varchar(50),esalary int);
insert into employee values(100,'ashish',12000),(101,'rahul',15000),(102,'rajesh',11000);
...
select sum(esalary),emp_id from employee group by emp_id; 
select emp_id,sum(esalary) from employee where esalary>=12000 group by emp_id;

/*select emp_id,sum(esalary) from employee group by emp_id having esalary>11000;*/
select emp_id,sum(esalary) from employee group by emp_id having sum(esalary)>11000;
select emp_id,sum(esalary) from employee group by emp_id having sum(esalary)<=15000;